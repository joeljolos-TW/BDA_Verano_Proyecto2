...
public class AlumnoDominio implements Serializable {
    ...
    public AlumnoDominio(String nombre, String apellidoPaterno, String apellidoMaterno, String contraseña, EstadosAlumno estado, List<ReservaDominio> reservas, CarreraDominio carrera) {
        this.nombre = nombre;
